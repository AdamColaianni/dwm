...
static char *fonts[]          = { "monospace:size=15", "JoyPixels:pixelsize=15:antialias=true:autohint=true"  };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_p,			spawn,		SHCMD("playerctl stop") },
	...
	{ MODKEY|ShiftMask,		XK_m,		spawn,		SHCMD(TERMINAL " -e castero") },
	...
	{ MODKEY|ShiftMask|Mod1Mask,		XK_j,	tagmon,		{.i = -1 } },
	{ MODKEY|Mod1Mask,			XK_k,	focusmon,	{.i = +1 } },
	{ MODKEY|ShiftMask|Mod1Mask,		XK_k,	tagmon,		{.i = +1 } },
	...
	{ MODKEY,			XK_F1,		spawn,		SHCMD("groff -mom ~/.local/src/dwm/anus.mom -Tpdf | zathura -") },
